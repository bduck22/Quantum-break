Shader "TheToonShader/Optimized/URP/Unity6/TheToonShader_WithOutline_RepairDrone_Body_Optimized"
{
   Properties
   {
...
[HideInInspector]_QueueOffset("_QueueOffset", Float) = 0
   ...
   SubShader
   {
	...
	HLSLINCLUDE
		...
		#define _CASTSHADOWS_STYLING_DRAWSPACE 1
		#define _CASTSHADOWS_STYLING_UVSET 0
		#define _CASTSHADOWS_STYLING_COORDINATESYSTEM 0
		#define _CASTSHADOWS_STYLE 0
		#define _CASTSHADOWS_STYLING_NUMBER_OF_CELLS_HATCHING 1
		#define _ENABLE_OUTLINE 1
	ENDHLSL
